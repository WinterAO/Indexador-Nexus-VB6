...
Private Declare Sub RtlMoveMemory _
                Lib "kernel32" (ByVal Destination As Long, _
...
Private Declare Function TrackMouseEventComCtl _
                Lib "Comctl32" _
                Alias "_TrackMouseEvent" (ByRef lpEventTrack As TRACKMOUSEEVENT_STRUCT) As Long
...
Private Declare Function ShellExecuteEx _
                Lib "shell32.dll" (ByRef SEI As typSHELLEXECUTEINFO) As Long
...
Private Declare Function SetWindowLongW _
                Lib "user32" (ByVal hwnd As Long, _
                              ByVal nIndex As Long, _
                              ByVal dwNewLong As Long) As Long
Private Declare Function GetWindowLongW _
                Lib "user32" (ByVal hwnd As Long, _
...
Private Declare Function SendMessageAsLong _
                Lib "user32" _
...
Private Declare Function SetRect _
                Lib "user32" (ByRef lpRect As RECT, _
                              ByVal x1 As Long, _
                              ByVal y1 As Long, _
                              ByVal x2 As Long, _
...
Private Declare Function DrawTextA _
                Lib "user32" (ByVal hDC As Long, _
                              ByVal lpStr As String, _
                              ByVal nCount As Long, _
                              ByRef lpRect As RECT, _
                              ByVal wFormat As Long) As Long
Private Declare Function DrawTextW _
                Lib "user32" (ByVal hDC As Long, _
...
Private Declare Function DrawThemeBackground _
                Lib "uxtheme.dll" (ByVal mhTheme As Long, _
...
Private Declare Function InitialiseFlatSB _
                Lib "comctl32.dll" _
                Alias "InitializeFlatSB" (ByVal lHwnd As Long) As Long
...
Private Declare Function FlatSB_ShowScrollBar _
                Lib "comctl32.dll" (ByVal hwnd As Long, _
...
Private Declare Function UninitializeFlatSB _
                Lib "comctl32.dll" (ByVal hwnd As Long) As Long
...
Private Declare Function OleCreatePictureIndirect _
                Lib "olepro32.dll" (ByRef lpPictDesc As typPICTDESC, _
...
Public Event CustomSort(Ascending As Boolean, _
                        Col As Long, _
                        Value1 As String, _
                        Value2 As String, _
                        Swap As Boolean)
...
Public Event AfterEdit(ByVal Row As Long, _
                       ByVal Col As Long, _
                       ByRef vNewValue As String, _
...
Public Function AddRow(Optional ByVal vstrItem As String, _
    ...
    If Me.Cols = 0 Then
        ...
        If IsInIDE Then
            Debug.Print "IDE Debug: No Columns Added" & vbNewLine & "Function AddRow", vbExclamation, "DEBUG"
        End If
    End If
...
Private Sub ApplyCellFormat(ByVal vRow As Long, _
    ...
    If mRowCount = C_NULL_RESULT Then '// prevent errors
        If IsInIDE Then
            Debug.Print "IDE Debug: No Rows Added" & vbNewLine & "Sub ApplyCellFormat", vbExclamation, "DEBUG"
        End If
        Exit Sub
    End If
...
Public Property Let CellAlignment(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As lgAlignmentEnum)
...
Public Property Let CellBackColor(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Long)
...
Public Property Get CellChecked(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT) As Boolean
...
Public Property Let CellChecked(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Boolean)
...
Public Property Let CellFontBold(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Boolean)
...
Public Property Let CellFontItalic(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Boolean)
...
Public Property Let CellFontName(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As String)
...
Public Property Let CellFontUnderline(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Boolean)
...
Public Property Let CellForeColor(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Long)
...
Public Property Let CellHandPointer(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Boolean)
...
Public Property Let CellImage(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Variant)
...
Public Property Let CellProgressValue(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Integer)
...
Public Property Get CellTag(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT) As String
...
Public Property Let CellTag(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As String)
...
Public Property Get CellText(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT) As String
...
Public Property Let CellText(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As String)
...
Public Property Get CellValue(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT) As Variant
...
Public Property Let CellValue(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Variant)
...
Public Property Let CellWordWrap(Optional ByVal vRow As Long = C_NULL_RESULT, Optional ByVal vCol As Long = C_NULL_RESULT, ByVal vNewValue As Boolean)
...
Private Function ColorBrightness(ByVal lngColor As Long, _
                                 Optional ByVal Alpha As Integer = -50) As Long
...
Private Sub DrawCustom3DHeader(ByVal lHDC As Long, _
                                    ...
                                    If mR.ImageSpace Then
                                        ...
                                        If Not (mItems(mRowPtr(lRow)).lImage = 0) Then
                                            ...
                                            If bLockColor And mbApplySelectionToImages Then
                                                moImageList.ListImages(Abs(mItems(mRowPtr(lRow)).lImage)).Draw .hDC, lImageLeft, ScaleY(lY + lImgTop, vbPixels, mImageListScaleMode), 2
                                            Else
                                                moImageList.ListImages(Abs(mItems(mRowPtr(lRow)).lImage)).Draw .hDC, lImageLeft, ScaleY(lY + lImgTop, vbPixels, mImageListScaleMode), 1
                                            End If
   
                                        End If
                                    End If
   
                                    Call SetRect(R, mR.LeftText + C_TEXT_SPACE + mlngRowNoWidth, lY, (lX + mCols(mColPtr(lCol)).lWidth) - C_TEXT_SPACE, lY + mItems(mRowPtr(lRow)).lHeight)
   
                                    '----------------------------------------------------------------------------------------------
                                Else '// all columns but 0
                                    Call SetRect(R, lX + C_TEXT_SPACE, lY, (lX + mCols(mColPtr(lCol)).lWidth) - C_TEXT_SPACE, lY + mItems(mRowPtr(lRow)).lHeight)
                                        ...
                                        With mItems(mRowPtr(lRow)).Cell(mColPtr(lCol))
                                            ...
                                            Else
                                                ...
                                                If Not (nImage = 0) Then
                                                    ...
                                                    If IR.Left >= 0 Then
                                                        If bLockColor And mbApplySelectionToImages Then
                                                            moImageList.ListImages(Abs(nImage)).Draw UserControl.hDC, ScaleX(IR.Left, vbPixels, mImageListScaleMode), ScaleY(lY + lImgTop, vbPixels, mImageListScaleMode), 2
   
                                                        Else
                                                            moImageList.ListImages(Abs(nImage)).Draw UserControl.hDC, ScaleX(IR.Left, vbPixels, mImageListScaleMode), ScaleY(lY + lImgTop, vbPixels, mImageListScaleMode), 1
                                                        End If
        ...
        If lCol > C_NULL_RESULT Or vblnRowNumbers Then
            ...
            With UserControl
                ...
                Else
                    ...
                    Call SetRect(R, mCols(mColPtr(lCol)).lX - 1 + mlngRowNoWidth, mR.CaptionHeight, mCols(mColPtr(lCol)).lX + mCols(mColPtr(lCol)).lWidth + mlngRowNoWidth, mR.HeaderHeight)
                End If
                ...
                If mCols(mColPtr(lCol)).lWidth > C_SIZE_SORTARROW Then
                    ...
                    If mColPtr(lCol) = mSortColumn Then
                        DrawSortArrow (mCols(mColPtr(lCol)).lX + mCols(mColPtr(lCol)).lWidth) + mlngRowNoWidth - 12, mR.CaptionHeight + 6, 9, 5, mCols(mColPtr(lCol)).nSortOrder
   
                        Call SetRect(R, mCols(mColPtr(lCol)).lX + C_TEXT_SPACE, mR.CaptionHeight, (mCols(mColPtr(lCol)).lX + mCols(mColPtr(lCol)).lWidth) - (C_ARROW_SPACE + C_SIZE_SORTARROW), mR.HeaderHeight)
   
                    ElseIf mColPtr(lCol) = mSortSubColumn Then
                        DrawSortArrow (mCols(mColPtr(lCol)).lX + mCols(mColPtr(lCol)).lWidth) + mlngRowNoWidth - 12, mR.CaptionHeight + 6, 6, 3, mCols(mColPtr(lCol)).nSortOrder
   
                        Call SetRect(R, mCols(mColPtr(lCol)).lX + C_TEXT_SPACE, mR.CaptionHeight, (mCols(mColPtr(lCol)).lX + mCols(mColPtr(lCol)).lWidth) - (C_ARROW_SPACE + C_SIZE_SORTARROW), mR.HeaderHeight)
                    Else
                        Call SetRect(R, mCols(mColPtr(lCol)).lX + C_TEXT_SPACE, mR.CaptionHeight, (mCols(mColPtr(lCol)).lX + mCols(mColPtr(lCol)).lWidth) - (C_TEXT_SPACE * 2), mR.HeaderHeight)
                    End If
...
Private Sub DrawOfficeXPHeader(ByVal lHDC As Long, _
                               ByRef rRect As RECT, _
                               ByVal State As lgHeaderStateEnum)
...
Private Sub DrawRect(ByVal lngHDC As Long, _
                     ByRef RC As RECT, _
                     ByVal lColor As Long, _
                     Optional ByVal bFilled As Boolean = True)
...
Public Sub ExportGrid(ByVal strGridName As String, _
    ...
    If Not mRowCount = C_NULL_RESULT Then '// Error Prevention
        ...
        If MsgBox("File " & strGridName & " was saved to your desktop." & vbNewLine & "Do you want to open it?", vbQuestion Or vbYesNo) = vbYes Then
...
Private Function FixRef(ByRef vRow As Long, _
                        Optional ByRef vCol As Long = C_NULL_RESULT) As Boolean
    ...
    ElseIf IsInIDE Then
        Debug.Print "IDE Debug: No Rows Added" & vbNewLine & "Function FixRef", vbExclamation, "DEBUG"
        FixRef = False
    End If
...
Private Function HandCursorHandleToPicture(ByVal hHandle As Long, _
                                           ByVal isBitmap As Boolean) As IPicture
...
Private Sub pSBGetSI(ByVal eBar As EFSScrollBarConstants, _
...
Private Sub pSBLetSI(ByVal eBar As EFSScrollBarConstants, _
                     ByRef tSI As SCROLLINFO, _
                     ByVal fMask As Long)
...
Public Sub RemoveRow(Optional ByVal vRow As Long = C_NULL_RESULT)
    ...
    If mRowCount = C_NULL_RESULT Then '// prevent error
        If IsInIDE Then
            Debug.Print "IDE Debug: No Rows Added" & vbNewLine & "Sub RemoveItem", vbExclamation, "DEBUG"
        End If
        Exit Sub
    End If
...
Private Function RowTopY(ByVal Index As Long, _
                         Optional ByVal lStart As Long = C_NULL_RESULT) As Long
...
Private Sub SetFlag(ByRef nFlags As Integer, _
                    ByVal nFlag As lgFlagsEnum, _
        ...
        If LenB(mItems(mRowPtr(lRow)).Cell(mColPtr(lCol)).sValue) Then
            If IsValidRowCol(lRow, lCol) Then
                If Not (mCols(mColPtr(lCol)).nType = lgBoolean) Then
                    ...
                    picTooltip.Move (R.Left + CR.Left) * Screen.TwipsPerPixelX, (R.Top + CR.Top) * Screen.TwipsPerPixelY, RectM.Right * Screen.TwipsPerPixelX, RectM.Bottom * Screen.TwipsPerPixelY
...
Private Sub SortArray(ByVal lFirst As Long, _
...
Private Sub SortArrayBool(ByVal lFirst As Long, _
                          ByVal lLast As Long, _
                          ByVal lSortColumn As Long, _
                          ByVal nSortType As Integer)
...
Private Sub SortArrayCustom(ByVal lFirst As Long, _
                            ByVal lLast As Long, _
                            ByVal lSortColumn As Long, _
                            ByVal nSortType As Integer)
...
Private Sub SortArrayDate(ByVal lFirst As Long, _
                          ByVal lLast As Long, _
                          ByVal lSortColumn As Long, _
                          ByVal nSortType As Integer)
...
Private Sub SortArrayString(ByVal lFirst As Long, _
                            ByVal lLast As Long, _
                            ByVal lSortColumn As Long, _
                            ByVal nSortType As Integer)
...
Private Function TranslateColor(ByVal clrColor As OLE_COLOR, _
                                Optional ByRef hPalette As Long = 0) As Long
