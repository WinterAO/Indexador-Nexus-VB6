...
'on error resume next
    ...
    Contra = "72s&o#trMKj6U4qPZEdN0SwA0r"
...
Private Sub encryptHeaderFile(ByRef FileHead As FILEHEADER)
    ...
    With FileHead
        .lngNumFiles = .lngNumFiles Xor 36724
        .lngFileSize = .lngFileSize Xor 235362179
    End With
End Sub
...
Private Sub encryptHeaderInfo(ByRef InfoHead As INFOHEADER)
    ...
    'Each different variable is encrypted with a different key for extra security
    With InfoHead
        .lngFileSize = .lngFileSize Xor 221762492
        .lngFileSizeUncompressed = .lngFileSizeUncompressed Xor 43791882
        .lngFileStart = .lngFileStart Xor 175422416
...
On Local Error GoTo errhandler
    ...
    Select Case File_Type
        ...
        Case Graphics
                SourceFilePath = DirCliente & "Recursos\" & "Graficos" & Formato
            
        Case Music
                SourceFilePath = DirCliente & "Recursos\" & "Musica" & Formato
                
        Case Midi
                SourceFilePath = DirCliente & "Recursos\" & "Midi" & Formato
        
        Case Wav
                SourceFilePath = DirCliente & "Recursos\" & "Sounds" & Formato

        Case Scripts
                SourceFilePath = DirCliente & "Recursos\" & "Scripts" & Formato

        Case Interface
                SourceFilePath = DirCliente & "Recursos\" & "Interface" & Formato

        Case Map
                SourceFilePath = DirCliente & "Recursos\" & "Mapas" & Formato

        Case Ambient
                SourceFilePath = DirCliente & "Recursos\" & "Ambient" & Formato
                
        Case Fuentes
                SourceFilePath = DirCliente & "Recursos\" & "Fuentes" & Formato
