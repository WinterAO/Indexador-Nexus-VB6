...
Sub Engine_Init_FontTextures()
    ...
    For i = 1 To UBound(cfonts)
        ...
        #If Comprimido = 1 Then
            ...
            InfoHead = File_Find(DirCliente & "Fuentes" & Formato, "font" & CStr(i) & ".png")
            ...
            If InfoHead.lngFileSize <> 0 Then
                ...
                'Set the texture
                Set cfonts(i).Texture = DirectD3D8.CreateTextureFromFileInMemoryEx(DirectDevice, Data(0), UBound(Data) + 1, D3DX_DEFAULT, D3DX_DEFAULT, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_POINT, D3DX_FILTER_POINT, &HFF000000, ByVal 0, ByVal 0)
        ...
        #Else
            ...
            Graphic = DirCliente & "Fuentes\font" & CStr(i)
                
            If FileExist(Graphic & ".png", vbNormal) Then
                Set cfonts(i).Texture = DirectD3D8.CreateTextureFromFileEx(DirectDevice, Graphic & ".png", D3DX_DEFAULT, D3DX_DEFAULT, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_POINT, D3DX_FILTER_POINT, &HFF000000, ByVal 0, ByVal 0)
                
            Else
                'Call MsgBox("No se ha podido cargar el grafico con indice: " & Graphic)
                'Call CloseClient
                Call AddtoRichTextBox(frmMain.RichConsola, "No se ha podido cargar el grafico font" & CStr(i) & ".png", 255, 0, 0, True)
...
Sub Engine_Init_FontSettings()
    ...
    For i = 1 To UBound(cfonts)
        ...
        InfoHead = File_Find(DirCliente & "Fuentes" & Formato, LCase$("Font" & i & ".dat"))
